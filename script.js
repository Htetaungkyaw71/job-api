...
import { CompanySize, HiringStatus, JobLevel, JobType, Role, } from "./generated/prisma/enums.js";
...
function normalizeJobType(value) {
    ...
    if (v.includes("CONTRACT") || v.includes("B2B"))
...
async function main() {
    ...
    const scrapedJobs = JSON.parse(jsonRaw);
